...
10. Abstract nouns where a thing belongs, and atmosphere adverbs where a verb belongs. "A reminder of loss" where the gutter he never fixed belongs. Name the object, the person, the place, the day. Prefer a strong verb to an adverb; cut "very," "really," "quite." And cut the stock adverbs that add mood instead of meaning: "quietly," "subtly," "effortlessly," "profoundly," "deeply," "truly," "fundamentally," "remarkably." "X quietly runs Y" says nothing that "X runs Y" did not, except that the writer wanted it to sound significant.
...
15. The sweeping claim about people. "Most people never ask this." "We all know the feeling." "Everyone wants to be seen." "Nobody talks about the cost." An over-simplification standing in for an argument: it asserts a crowd the writer has not counted, so the reader cannot check it and the sentence cannot be wrong. Say who, specifically, and what you actually saw them do; or make the claim about yourself, where it can be true.
...
16. One controlling metaphor mechanically reapplied. The same phrase ("their own picture," "the picture they held") stamped onto every section, from a traffic slight to an atrocity, as the load-bearing scaffold that holds unlike material together. A human essayist lets vocabulary shift with the stakes. Use a governing image where it earns its place and let it go where it does not; if a phrase appears in more than two sections, the third is a habit, not a choice.
...
export const MACHINE_TELLS_SUMMARY =
  'a dash used between clauses or to fence off an aside (flag EVERY one); the negation-first frame ("This is not X. It is Y.", "not just X, but Y"); a line announcing an idea\'s importance instead of showing it ("the difference matters more than almost anything", "here is the thing", "this is the crux", "that changes everything"); over-the-top comparison or hyperbole ("nothing less than", "the single most"); the rule-of-three reflex; signposting (firstly, in conclusion, it is important to note); hedge stacks and stock qualifiers (genuine, genuinely, in some sense, at least); atmosphere adverbs (quietly, subtly, effortlessly, profoundly); the sweeping claim about people ("most people", "we all", "everyone knows", "nobody talks about"); thesaurus diction (delve, tapestry, underscore); uniform sentence rhythm; a rhetorical question that answers itself; a colon reveal or one-word sentence used as a punchline; an ending that summarizes; and the structural fingerprints: one controlling metaphor or phrase reapplied in every section, every case study run through the same template (describe, "from their perspective", name the belief, quote, gloss, same conclusion), meta-narration of the essay\'s own structure ("this essay moves from"), every paragraph shaped topic-elaboration-quote-takeaway, and a single first-person anecdote in a different register from the rest'
