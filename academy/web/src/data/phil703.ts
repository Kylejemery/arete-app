...
export const PHIL_703_SESSIONS: Phil703Session[] = [
  // ── SESSION 1 ──────────────────────────────────────────────────────────────
  {
    ...
    quiz: [
      {
        question: "1. What does the name 'Epiktētos' mean, and why is it philosophically significant?",
        answer: "It means 'acquired' — the name of property. The philosopher of freedom was named as a thing owned, and his central claim — that the will cannot be enslaved — was forged inside the condition his own name described.",
      },
      {
        question: "2. Who recorded the Discourses, and what did he claim to be preserving?",
        answer: "Arrian (Flavius Arrianus), Epictetus's student. He claimed to preserve not doctrines but Epictetus's voice — his way of thinking and the frankness of his speech, written down as nearly as possible in his own words.",
      },
      {
      ...
      {
        question: "4. What was the formal morning curriculum of the school, and what do the Discourses record instead?",
        answer: "The formal curriculum was technical Chrysippean Stoicism — logic, physics, ethics read and analyzed. The Discourses record the application layer around it: the talks that drove that material into the students' actual conduct.",
      },
      {
      ...
      {
        question: "6. According to Discourses I.1, what is the one thing the gods gave us as fully our own?",
        answer: "The correct use of impressions (chrēsis phantasiōn) — the power of prohairesis to examine what appears and to assent, refuse, desire, or reject. Body, property, reputation, and office are not ours in this sense.",
      },
      {
