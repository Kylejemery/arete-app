...
export interface Phil701Session {
  ...
  // open (question + reference answer, graded by the Proctor), mc, or msq —
  // see StudentQuiz.
  quiz: QuizQuestion[];
  practiceAssignment?: {
    coreIdea: string;
...
export const PHIL_701_SESSIONS: Phil701Session[] = [
  {
    ...
    "quiz": [
      {
        "type": "msq",
        "question": "1. Which of the following are the three Stoic categories of value?",
        "options": ["Goods (agatha)", "Preferred outcomes (proēgmena)", "Bads (kaka)", "Externals (ta ektos)", "Indifferents (adiaphora)"],
        "correct": [0, 2, 4],
        "explanation": "Everything falls into goods (virtue), bads (vice), or indifferents (everything else). 'Preferred' and 'external' are descriptions within the indifferent class, not categories of value themselves."
      },
      {
      ...
      },
      {
        ...
        "options": ["Kathēkonta", "Proēgmena adiaphora", "Eupatheiai", "Apoproēgmena"],
        "correct": 1,
        "explanation": "Proēgmena adiaphora — indifferents 'promoted' to selective value. Apoproēgmena are the dispreferred; kathēkonta are appropriate actions; eupatheiai the good emotions."
      },
      {
  ...
  },
  {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": ["An impression arising from the world", "Assent — the voluntary act of affirming an impression's content", "The impulse toward action", "The ruling faculty itself"],
        "correct": 1,
        "explanation": "Assent is the one fully voluntary stage of the chain — the act of affirming that an impression's content is accurate."
      },
      {
      ...
      },
      {
        ...
        "options": ["Impression → assent → impulse → action", "Assent → impression → action → impulse", "Impulse → impression → assent → action", "Impression → impulse → assent → action"],
        "correct": 0,
        "explanation": "The world presents an impression; the ruling faculty assents (or not); assent generates impulse; impulse issues in action. Responsibility lives at the second link."
      },
      {
  ...
  },
  {
    ...
    "quiz": [
      {
        "type": "msq",
        "question": "1. Which of the following are Epictetus's three disciplines?",
        "options": ["Desire & aversion", "Wealth & poverty", "Impulse & action", "Pleasure & pain", "Assent & judgment"],
        "correct": [0, 2, 4],
        "explanation": "The three topoi: desire/aversion (what to want), impulse/action (how to act), assent/judgment (what to affirm). Wealth and pleasure are objects the disciplines govern, not disciplines."
      },
      {
      ...
      },
      {
        ...
        "options": ["A refusal to pursue external goals at all", "A mental reservation added to every pursuit: 'I will do this — fate permitting'", "A prayer for good fortune before acting", "A promise to abandon goals that become difficult"],
        "correct": 1,
    ...
    "quiz": [
      {
        ...
        "options": ["Perfect virtuous action, available only to the Sage", "Appropriate action — fitting to one's nature, role, and circumstances", "A passion arising from false judgment", "The divine rational principle"],
        "correct": 1,
        "explanation": "Kathēkon is appropriate action with a reasonable justification — available to the progressing student. Perfect action (katorthōma) belongs to the Sage alone."
      },
      {
      ...
      },
      {
        ...
        "options": ["The obligation to obey the state", "Natural affiliation — self-care extended, in rational beings, to all rational beings", "The rejection of family ties for philosophy", "The Sage's withdrawal from society"],
        "correct": 1,
        "explanation": "Oikeiōsis is the natural affiliation that begins with self-preservation and widens, as reason matures, to encompass all rational beings — the root of Stoic cosmopolitanism."
      },
      {
    ...
    "quiz": [
      {
        ...
        "options": ["The evening review of the day's actions", "Continuous attention and vigilance over impressions as they arise", "The contemplation of death", "The view from above"],
        "correct": 1,
        "explanation": "Prosochē is the standing watchfulness over the ruling faculty — the foundational spiritual exercise on which the others depend."
      },
      {
      ...
      {
        "type": "msq",
        "question": "3. Which of the following are the three steps in testing an impression?",
        "options": ["Is this eph' hēmin or not?", "Is this pleasurable or painful?", "Is this a genuine good/bad or an indifferent?", "Does this advance my ambitions?", "Is the content of the impression accurate?"],
        "correct": [0, 2, 4],
        "explanation": "The assay asks jurisdiction (up to me?), value (good, bad, or indifferent?), and accuracy (is the claim true?). Pleasure and ambition are exactly what the test screens out."
      },
      {
  ...
  },
  {
    ...
    "quiz": [
      ...
      {
        "type": "msq",
        "question": "2. Which of the following are the four Stoic passions?",
        "options": ["Desire (epithumia)", "Anger (orgē)", "Fear (phobos)", "Pleasure (hēdonē)", "Envy (phthonos)", "Distress (lupē)"],
        "correct": [0, 2, 3, 5],
        "explanation": "The four generic passions: desire, fear, pleasure, distress. Anger and envy are species of these (anger a form of desire for revenge; envy a form of distress), not the generic four."
      },
      {
        "type": "msq",
        "question": "3. Which of the following are the three eupatheiai?",
        "options": ["Wish (boulēsis)", "Hope (elpis)", "Caution (eulabeia)", "Joy (chara)", "Pity (eleos)"],
        "correct": [0, 2, 3],
        "explanation": "The good emotions: wish (rational desire), caution (rational aversion), joy (rational elation). There is no rational counterpart to distress — the Sage has no occasion for it."
      },
      {
    ...
    "quiz": [
      {
        ...
        "options": ["The ruling faculty of the soul", "Fate — the causal chain governing all events, identified with the logos, God, and nature", "A pre-passion preceding emotion", "The Stoic term for chance"],
        "correct": 1,
        "explanation": "Heimarmenē is fate: the seamless causal weave of the universe, which the Stoics identify with the logos, God, and nature — one thing under four names."
      },
      {
      ...
      },
      {
        ...
        "options": ["Resigned endurance of what cannot be changed", "Love of fate — the affirmative embrace of reality as governed by a rational, providential logos", "The fear of fate that motivates prudence", "The belief that fate can be bargained with"],
        "correct": 1,
        "explanation": "Amor fati goes beyond acceptance: not 'I endure what I cannot change' but 'I would not change it — it is the logos's work and the material for virtue.'"
      },
      {
  ...
  },
  {
    ...
    "quiz": [
      ...
      },
      {
        ...
        "options": ["Planning revenge against wrongdoers", "Negative visualization — imagining the loss of what you value to prevent attachment and prepare for adversity", "Morbid dwelling on death for its own sake", "Predicting the future through omens"],
        "correct": 1,
        "explanation": "The premeditation of adversity rehearses loss in advance — reducing shock, loosening attachment, and sharpening gratitude for what is presently held on loan."
      },
      {
    ...
    "quiz": [
      {
        ...
        "options": ["Pleasure wisely managed (hēdonē)", "Living according to nature (kata phusin zēn)", "Freedom from all feeling (apatheia as numbness)", "Political honor earned through service"],
        "correct": 1,
        "explanation": "The telos is living according to nature — the three-fold alignment with cosmic nature (the logos), human nature (rational and social), and individual nature (your constitution and roles)."
      },
      {
      ...
      {
        "type": "msq",
        "question": "3. Which of the following are the three senses of 'nature' in the Stoic formula?",
        "options": ["Cosmic nature (the logos/fate)", "Animal nature (instinct and appetite)", "Human nature (rational, social animal)", "Divine nature apart from the world", "Individual nature (your constitution, roles, circumstances)"],
        "correct": [0, 2, 4],
        "explanation": "Cosmic, human, and individual — the whole, the kind, and the particular. Instinct is what reason supersedes, and the Stoic God is not apart from the world but immanent in it."
      },
      {
    ...
    "quiz": [
      {
        ...
        "options": ["Whether wealth is sufficient for a comfortable life", "Whether virtue is genuinely sufficient for happiness, even in extreme poverty, illness, or suffering", "Whether the Sage needs the disciplines at all", "Whether happiness admits of degrees"],
        "correct": 1,
        "explanation": "The sufficiency question tests the school's central claim at its hardest point: could the Sage be eudaimōn on the rack, in poverty, in loss? The Stoic answer is yes — virtue alone completes the good."
      },
      {
      ...
      {
        "type": "mc",
        "question": "6. What does the 'Sage in chains is free' paradox demonstrate?",
        "options": ["That freedom of movement is an illusion for everyone", "That Stoic freedom is internal — the ruling faculty's power to assent or withhold assent, which chains cannot constrain", "That the Sage prefers imprisonment as a spiritual exercise", "That external constraint eventually breaks every soul"],
        "correct": 1,
        "explanation": "Chains bind the body; assent remains the soul's own. Stoic freedom is the rational self-governance of the ruling faculty — the one jurisdiction external force cannot enter."
      },
      {
