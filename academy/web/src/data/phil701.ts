    ...
    "parts": [
      ...
      },
      {
        ...
        "content": [
          ...
          "Stage 3 — The Completeness Claim: Virtue is sufficient for happiness (eudaimonia). This is the most contested Stoic claim. The Sage who has virtue has everything needed for a complete and flourishing life, even in poverty, illness, or chains. Virtue is not merely necessary for happiness; it is sufficient."
        ],
        "tables": [
          [
            [
    ...
    "parts": [
      {
        ...
        "content": [
          "The Stoics held that the soul has a ruling part — the hēgemonikon — which is the seat of rational activity, located (they believed) in the heart. All the distinctively human operations of mind — perception, thought, impulse, judgment — are functions of the hēgemonikon. It is not a metaphor; for the Stoics it is a specific physical locus of pneumatic activity in the chest.",
          "The hēgemonikon performs seven functions, of which the most philosophically important are: receiving impressions (phantasiai), giving or withholding assent (synkatathesis), generating impulse toward or away from action (hormē and ekklinsis), and exercising reason (logos). These functions are not separable faculties — they are aspects of a single unified activity.",
  ...
  },
  {
    ...
    "parts": [
      ...
      },
      {
        ...
        "content": [
          "The Stoics grounded their social ethics in the concept of oikeiōsis — often translated 'appropriation' or 'affiliation.' All animals have a natural affiliation with themselves — they care for their own continued existence and functioning. In rational animals, this self-affiliation extends outward through reason to encompass all rational beings.",
    ...
    "parts": [
      {
        ...
        "content": [
          "Pierre Hadot, in Philosophy as a Way of Life, identifies prosochē — continuous attention to oneself and one's present state — as the fundamental Stoic spiritual exercise from which all others derive. 'It is a continuous vigilance and presence of mind, self-consciousness which never sleeps, and a constant tension of the spirit.'",
          "What is one attending to? Not feelings, not memories, not future plans — but impressions as they arise in the ruling faculty. The practice is: when an impression arises, see it for what it is — a presentation of the world as being a certain way — before deciding whether to assent to it. The Stoic does not sleepwalk through the day, automatically assenting to every impression the world sends. She watches.",
    ...
    "parts": [
      {
        ...
        "content": [
          "The Stoic definition of passion (pathos) is precise: a passion is an irrational and unnatural movement of the soul arising from a false judgment about value. It is not the feeling accompanying an event, but the judgment embedded in that feeling — the implicit claim that this external thing is a genuine good or genuine bad.",
          "Fear (phobos) is not merely the physiological arousal that accompanies a threat. It is a judgment: 'this approaching thing is a genuine evil that I must avoid.' If the thing is genuinely evil (e.g., a vicious action), the avoidance is appropriate — it is the eupatheia caution (eulabeia), not fear. If the thing is an indifferent (death, illness, poverty), the avoidance is based on a false judgment — and that is the passion fear.",
    ...
    "parts": [
      {
        ...
        "content": [
          "The Stoics held that the universe is a single living organism, pervaded and governed by the divine rational principle they called the logos. This logos is identical with God, with fate (heimarmenē), with nature, and with universal reason. These are not different entities — they are different descriptions of the same omnipresent rational principle.",
  ...
  },
  {
    ...
    "parts": [
      ...
      },
      {
        ...
        "content": [
          "The prokopton (one making progress) occupies the practical middle of Stoic ethics. Not a Sage, not entirely in the grip of passion and false judgment — but genuinely improving, with an orientation toward virtue and an increasingly reliable practice of the three disciplines.",
      ...
      },
      {
        ...
        "content": [
          "How does the prokopton make progress? Hadot's central contribution to Stoic scholarship is his identification of specific spiritual exercises as the mechanism of moral development. These are not intellectual activities — they are practices that transform perception, desire, and character through repetition.",
  ...
  },
  {
    ...
    "parts": [
      ...
      },
      {
        ...
        "content": [
          "The goal of living according to nature is eudaimonia — a Greek term often translated 'happiness' but better understood as 'flourishing' or 'the good life.' Eudaimonia for the Stoics is not a feeling state (not what we mean by 'feeling happy') but a condition of the soul: the stable, excellent functioning of the rational faculty in accordance with virtue.",
      ...
      },
      {
        ...
        "content": [
          "What does the life 'according to nature' actually look like from the outside? Not, as the caricature has it, a life of cold detachment and indifference to everything that happens. The Stoic telos produces a specific kind of engagement with the world.",
  ...
  },
  {
    ...
    "parts": [
      ...
      },
      {
        ...
        "content": [
          "Philosophy as transformation is Hadot's central theme — and it is the question that matters most for the practical purposes of this course. Knowing Stoicism is not practicing Stoicism. The gap between knowledge and practice is exactly what the spiritual exercises are designed to close.",
