...
const EXAM_SYLLABI: Record<string, string> = {
  ...
  'phil-706': `PHIL 706 — The Impossibility of Willing Evil. Core examinable doctrine: Socratic intellectualism — virtue is knowledge, vice is ignorance; the Protagoras measurement argument (akrasia as mismeasurement; the metrētikē technē; knowledge cannot be dragged about like a slave); the Gorgias distinction between doing what seems best and doing what one wills (all desire aims at the good; the tyrant as the least powerful man); the Meno argument that no one desires bad things; hamartia (missing the mark) vs willful transgression; Epictetus on error — the wrongdoer blinded in the judging faculty, shown or pitied, never raged at (Disc. 1.18); assent held by appearances, every soul unwillingly deprived of truth, Medea as the limit case (1.28); the contradiction inside every error and the skilled reprover (2.26); 'it seemed so to him' and the wrongdoer as the injured party (Ench. 42); Seneca's De Ira — anger defined as desire to avenge a wrong; the two-movements doctrine (involuntary propatheia vs anger proper at assent to 'I was wronged and retaliation is fitting'); the Gellius storm episode (pallor without passion); anger voluntary and therefore eliminable; against Peripatetic moderation (you cannot dose assent); the demolition of useful anger — motivation, courage, greatness of soul as inflamed smallness, the undistorted judge, punishment as medicine, deterrence by resolve not temperature; the full syllogism — anger's constituting judgment requires the willing wrongdoer, who does not exist, so anger is factually false in every instance; the hard cases (premeditated fraud thickening rather than thinning the error; cruelty as catastrophic value-error; Medea's comparison of goods); explaining vs excusing — retribution alone drops while restraint, correction, restitution, and deterrence survive; operative vs retributive responsibility and the mirror-symmetry check; Marcus's daily rehearsal (2.1 morning preparation, 7.22, 7.26, 8.14, 11.18 — the ten heads); the regimen — delay (maximum remedium irae mora est), the Sextius evening audit (De Ira 3.36), composing one's own morning preparation; the anger practicum protocol (flash, judgment, the offender's mistaken good, corrected response) and its data.`,
  'phil-707': `PHIL 707 — The Prokopton in the Digital Age. Core examinable doctrine: the engineered impression (a phantasia designed by an interested party, presenting a false good, optimized to bypass examination) and its three diagnostics (cui bono; the promised good stated in words; who owns the interval); the attention economy as industrialized phantasia machine; habit-arithmetic (Disc. 2.18) — each assent strengthens the next impression, fuel on the fire, and its reverse (reckon the days); trained assent vs both capitulation and retreat; askēsis rightly understood (3.12) — calibrated resistance aimed at one's own weakness, never display; prosoche as the standing guard over assent (4.12) — inattention as itself a training; Seneca Ep. 2 — everywhere is nowhere, dosage with digestion (unum aliquid); cadence — delivery engineered below the timescale of examination; the attention protocol (notification default-deny with the two-part test, placement rules as premeditatio in architecture, single-tasking blocks); tool-use vs impression-consumption; the metric as pure external and the migration of the standard from 'is it good?' to 'will it perform?'; Marcus on after-fame (4.19, 8.44) at feed-speed; comparison culture as assent to a systematically biased sample (publication is not life; Ench. 45 minimal description); the pile-on as scaled anger resting on the willing-evil error (PHIL 706 cross-over) and the correction test; engineered appetite — bliss-point food, variable-ratio reinforcement as unfalsifiable impression, Musonius on food and sex, Seneca Ep. 83 on drunkenness as voluntary madness, pornography analyzed through falsity/training-effect/self-command, temperance argued from freedom and command rather than shame; the graduated askēsis (delay, substitution, fasting period) and shame-free relapse analysis; externals — the preferred indifferent held strictly, lifestyle inflation as habit-arithmetic on 'enough', hustle culture's promotion of products to the good and its fear of stillness, the signal purchase, speculation as handing tranquility to Fortuna, premeditatio as position-sizing, the use/signal/consolation audit; fear at scale — Ep. 13's triage (present? probable? actionable?), information adequate for action vs fear rehearsal, the news protocol and headline drill, the political opponent as mistaken not evil (stating their pursued good without strawman), the health dichotomy (the body's states not up to us, care up to us, prognosis-rumination as assent-cascade); connection — Disc. 2.22's collision test, person-shopping and the inventory stance, ghosting, the parasocial bond as impression of reciprocity without reciprocity, Ep. 9's need/desire distinction, erēmia vs solitude, the AI companion's honest boundary (practice and counsel yes, mutual prohairesis no); Ep. 18 and the fast (scheduled, bounded, chosen; reveal, reset, prove); the Rule of Life — specific, doctrinally justified, reviewable; the assayer standard — trained assent in the world, owned by nothing.`,
}
