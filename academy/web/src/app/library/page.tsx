              ...
              <div style={{ marginTop: 26, position: 'relative' }}>
                ...
                {dreams.map((d, di) => (
                  <div key={d.id} style={{ marginBottom: 16 }}>
                    ...
                    {d.content ? (
                      <p style={{ fontFamily: SERIF, fontStyle: 'italic', fontSize: 16.5, lineHeight: 1.55, color: IVORY, margin: '0 0 7px', whiteSpace: 'pre-wrap' }}>{d.content}</p>
                    ) : (
                      <>
                        {d.title && <p style={{ fontFamily: SERIF, fontSize: 16.5, lineHeight: 1.4, color: IVORY, margin: '0 0 6px' }}>{d.title}</p>}
                        {d.firstLine && <p style={{ fontFamily: SERIF, fontStyle: 'italic', fontSize: 14, lineHeight: 1.5, color: MUTED, margin: '0 0 7px' }}>{d.firstLine}</p>}
                      </>
                    )}
