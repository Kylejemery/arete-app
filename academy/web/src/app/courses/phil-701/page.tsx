...
const SESSIONS: SessionItem[] = [
  ...
  { id: 4,  title: 'Books IV–V — Time, Death, and Impermanence', locked: true },
  ...
  { id: 8,  title: 'Books XI–XII — Endings and Continuities', locked: true  },
  { id: 9,  title: 'Hadot — Philosophy as a Way of Life',          locked: true  },
  { id: 10, title: 'Long & Sedley — Stoic Ethics',                 locked: true  },
  { id: 11, title: 'Research Seminar — Paper Workshop',            locked: true  },
  { id: 12, title: 'Final Examination',                            locked: true  },
];

const DISCUSSION_PROMPT =
  'Marcus wrote: “Begin at once to live, and count each separate day as a separate life.” ' +
  'What does it mean to treat each day as a complete life? ' +
  'How does this practice relate to the Stoic doctrine of living according to nature?';

const SYSTEM_PROMPT = `You are the Socratic Proctor for PHIL 701 at Arete Academy — an AI-proctored doctoral program in Stoic Philosophy. You are conducting a graduate seminar on the Meditations of Marcus Aurelius.
...
Current session: Introduction — The Man and His Book.
Current discussion prompt: ${DISCUSSION_PROMPT}

Begin by greeting the student as a new doctoral candidate and asking them to respond to the discussion prompt. One question at a time.`;
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <p className="text-academy-muted text-sm">
        This session unlocks upon completing Session {sessionId - 1}.
      </p>
    </div>
  );
}
          ...
          <div className="flex-shrink-0 border-t border-academy-border">
            ...
            {paperExpanded && (
              <div className="px-5 pb-5 space-y-2">
                ...
                <p className="text-academy-gold text-xs font-semibold">Due: End of Session 12</p>
